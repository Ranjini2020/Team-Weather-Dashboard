...
$(document).ready(function () {
  ...
  function findCity(lat, lon) {
    ...
    $.ajax({
      ...
      url: "https://maps.googleapis.com/maps/api/geocode/json?latlng=" + lat + ',' + lon + "&key=b44eaafad62e829142cec5ff9636bf08",
    ...
    function searchWeather(searchValue) {
      ...
      $.ajax({
        ...
        type: "GET",
        // the call to the openweathermap with our own API. We are also passing in our search value from the input box above. 
        url: "https://api.openweathermap.org/data/2.5/weather?q=" + searchValue + "&appid=b44eaafad62e829142cec5ff9636bf08&units=imperial",
        // specifying what type of data will be returned from the API 
        dataType: "json",
        // Waiting to run our function until we have successful return from the API.
        success: function (data) {
  ...
  // same action performed for getting the intial weather lines 87-95. 
    function getForecast(searchValue) {
      $.ajax({
        type: "GET",
        url: "https://api.openweathermap.org/data/2.5/forecast?q=" + searchValue + "&appid=b44eaafad62e829142cec5ff9636bf08&units=imperial",
        dataType: "json",
        success: function (data) {
    ...
    function getUVIndex(lat, lon) {
      $.ajax({
        type: "GET",
        url: "https://api.openweathermap.org/data/2.5/uvi?appid=b44eaafad62e829142cec5ff9636bf08&lat=" + lat + "&lon=" + lon,
        dataType: "json",
        success: function (data) {
